        ...
        <div className="pt-2 flex flex-wrap items-center gap-2">
          ...
          {periodOptions.map((opt) => {
            ...
            return (
              ...
              aria-pressed={active}>{opt.label}</AppLink>
            );
          })}
        </div>
      </div>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 font-medium">
                      <AppLink href={canonicalUrl}
                      className="text-zinc-100 hover:text-orange-400 transition-colors min-h-[44px] inline-flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500">{game.name}</AppLink>
